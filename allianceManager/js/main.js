function basedata() {
  ...
  request.open('GET', 'https://cors-anywhere.herokuapp.com/https://www.airline4.net/api/?access_token=oopr6tiPOULKHSLSIuerlSDL.SLHJDFlkwerKJhsdFKLuiyweu7&search=Star Alliance', true)
